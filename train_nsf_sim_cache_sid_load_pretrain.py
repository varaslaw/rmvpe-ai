...
# ============================================================
# УДАЛЁН НЕСУЩЕСТВУЮЩИЙ ИМПОРТ TensorBoardMetricsTracker
# Используется только стандартный TensorBoard через SummaryWriter
# ============================================================
...
def main():
    # ============================================================
    # ИСПРАВЛЕНО: Kaggle имеет только 1 GPU
    # Принудительно устанавливаем n_gpus = 1 для стабильности
    # ============================================================
    n_gpus = 1  # Kaggle T4 x1, без DDP ошибок
...
def run(rank, n_gpus, hps):
    ...
    # ============================================================
    # ИСПРАВЛЕНО: Добавлена обработка ошибок DDP
    # ============================================================
    try:
        ...
        if rank == 0:
            ...
            logger.info("Continuing with single GPU training")
    # ============================================================
